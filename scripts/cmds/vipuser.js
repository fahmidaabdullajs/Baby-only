...
module.exports = {
	...
	langs: {
		...
		en: {
			added: "✅ | Added vipUser role for %1 users:\n%2",
			alreadyvipUser: "\n⚠️ | %1 users already have vipUser role:\n%2",
			missingIdAdd: "⚠️ | Please enter ID or tag user to add author role",
			removed: "✅ | Removed vipUser role of %1 users:\n%2",
			notvipUser: "⚠️ | %1 users don't have vipUser role:\n%2",
			missingIdRemove: "⚠️ | Please enter ID or tag user to remove author role",
			listAdmin: "👑 | List of vipUser:\n%1"
		}
	},
