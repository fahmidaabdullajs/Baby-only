//Add command modules directly to GitHub repo
//Magdagdag ng mga command module nang direkta sa GitHub repo
//Thêm mô-đun lệnh trực tiếp vào repo GitHub
...
module.exports = {
 ...
 const githubToken = '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'; //add your GitHub token 
 const owner = 'rockexe77'; //add your GitHub username 
 const repo = 'Babyx7'; //add your repo name
 const branch = 'main';
